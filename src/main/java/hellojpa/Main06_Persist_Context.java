...
public class Main06_Persist_Context {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            /* 4. 지연로딩과 준영속
            * 준영속 관계로 만들어 버린 후에(close() 등), 지연로딩을 하려고 하면 LazyInitializationException 이 발생한다.
            * 가져오기 위한 근거는 영속성 컨텍스트에 다 있는데, 관계가 끊어져버렸기 때문
            * */
            ...
            * */
            ...
            /* 1. 이 이후에 findMember 에 대한 UPDATE 쿼리문을 안 써도, commit() 시 JPA 가 자동으로 쳐준다. */
